...
# @admin.register(PermitGasReading)
# class PermitGasReadingAdmin(admin.ModelAdmin):
#     list_display = (
#         "gas_test",
#         "gas_type",
#         "measured_value",
#         "is_safe",
#     )
#     list_filter = ("is_safe", "gas_type")
#     search_fields = (
#         "gas_test__permit__permit_number",
#         "gas_type__code",
#         "gas_type__name",
#         "remarks",
#     )
#     autocomplete_fields = ("gas_test", "gas_type")
#     readonly_fields = ("is_safe",)
#     ordering = ("gas_test", "gas_type__display_order")
